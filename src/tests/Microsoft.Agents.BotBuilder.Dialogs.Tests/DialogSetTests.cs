...
namespace Microsoft.Agents.BotBuilder.Dialogs.Tests
{
    public class DialogSetTests
    {
        ...
        public void Add_ShouldThrowOnNullDialog()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => ds.Add(null));
        }
        ...
        public void Add_ShouldApplySuffixId()
        {
            ...
            ds.Add(new WaterfallDialog(name));
            ds.Add(new WaterfallDialog(name));
            ds.Add(new WaterfallDialog(name));

            var dialogs = ds.GetDialogs();
...
#pragma warning disable CS0618 // Type or member is obsolete
            var ds = new DialogSet(property.Object);
#pragma warning restore CS0618 // Type or member is obsolete
            var context = new TurnContext(new TestAdapter(), new Activity());

            var dialogContext = await ds.CreateContextAsync(context);

            Assert.Equal(dialogContext.Stack, state.DialogStack);
        ...
        public async Task CreateContextAsync_ShouldThrowOnNullDialogStateAndProperty()
        {
            ...
            await Assert.ThrowsAsync<InvalidOperationException>(() => ds.CreateContextAsync(context));
        }
        ...
        public void Find_ShouldThrowOnNullOrEmptyDialogId()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => ds.Find(null));
            Assert.Throws<ArgumentNullException>(() => ds.Find(string.Empty));
        }
