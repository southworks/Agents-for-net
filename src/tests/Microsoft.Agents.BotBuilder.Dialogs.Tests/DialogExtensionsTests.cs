            ...
            return new TestFlow(adapter, async (turnContext, cancellationToken) =>
            {
                ...
                if (testCase != FlowTestCase.RootBotOnly)
                {
                    ...
                    if (testCase == FlowTestCase.RootBotConsumingSkill)
                    {
                        ...
                        turnContext.StackState.Set(ProxyChannelApiHandler.SkillConversationReferenceKey, new ChannelConversationReference { OAuthScope = AuthenticationConstants.BotFrameworkScope });
                    }
                    ...
                    if (testCase == FlowTestCase.MiddleSkill)
                    {
                        ...
                        turnContext.StackState.Set(ProxyChannelApiHandler.SkillConversationReferenceKey, new ChannelConversationReference { OAuthScope = _parentBotId });
                    }
                }
