...
namespace Microsoft.Agents.BotBuilder.Dialogs.Tests
{
    public class TestCloudAdapter : ChannelServiceAdapterBase
    {
        ...
        public Task<InvokeResponse> ProcessAsync(ClaimsIdentity claimsIdentity, Activity activity, BotCallbackHandler callback, CancellationToken cancellationToken = default)
        {
