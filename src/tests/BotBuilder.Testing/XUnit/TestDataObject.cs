...
namespace Microsoft.Agents.BotBuilder.Testing.XUnit
{
    /// <summary>
    ...
    public class TestDataObject : IXunitSerializable
    {
        ...
        {
            TestObject = ProtocolJsonSerializer.ToJson(testData);
        }
        ...
        {
            return ProtocolJsonSerializer.ToObject<T>(TestObject);
        }
    }
}
