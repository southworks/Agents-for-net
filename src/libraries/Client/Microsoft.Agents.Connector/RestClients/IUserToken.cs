...
namespace Microsoft.Agents.Connector.RestClients
{
    ...
    internal interface IUserToken
    {
        ...
        Task<TokenResponse> ExchangeAsync(string userId, string connectionName, string channelId, TokenExchangeRequest exchangeRequest, CancellationToken cancellationToken = default);
