...
namespace Microsoft.Agents.Hosting.AspNetCore.BackgroundQueue
{
    ...
    internal class ActivityTaskQueue : IActivityTaskQueue
    {
        ...
        /// <inheritdoc/>
        public void QueueBackgroundActivity(ClaimsIdentity claimsIdentity, IActivity activity, bool proactive = false, string proactiveAudience = null, Type agentType = null, Func<InvokeResponse, Task> onComplete = null, IHeaderDictionary headers = null)
        {
            ...
            _activities.Enqueue(new ActivityWithClaims { AgentType = agentType, ClaimsIdentity = claimsIdentity, Activity = activity, IsProactive = proactive, ProactiveAudience = proactiveAudience, OnComplete = onComplete, Headers = copyHeaders });
            _signal.Release();
        }
