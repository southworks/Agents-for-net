...
namespace Microsoft.Agents.Extensions.Teams.AI
{
    ...
    public class TeamsApplicationBuilder
    {
        ...
        /// </summary>
        public TeamsApplicationBuilder(IStorage storage)
            : this(new TeamsAgentApplicationOptions(storage))
        {
        }
        ...
        /// </summary>
        public TeamsAgentApplicationOptions Options { get; }
        ...
        /// <returns>The ApplicationBuilder instance.</returns>
        public TeamsApplicationBuilder WithAIOptions(AIOptions aiOptions)
        {
