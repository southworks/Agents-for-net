...
namespace Microsoft.Agents.Extensions.Teams.AI.Prompts.Sections
{
    ...
    public abstract class PromptSection
    {
        ...
        public abstract Task<RenderedPromptSection<List<ChatMessage>>> RenderAsMessagesAsync(ITurnContext context, ITurnState memory, IPromptFunctions<List<string>> functions, ITokenizer tokenizer, int maxTokens, CancellationToken cancellationToken = default);
        ...
        public virtual async Task<RenderedPromptSection<string>> RenderAsTextAsync(ITurnContext context, ITurnState memory, IPromptFunctions<List<string>> functions, ITokenizer tokenizer, int maxTokens, CancellationToken cancellationToken = default)
        {
