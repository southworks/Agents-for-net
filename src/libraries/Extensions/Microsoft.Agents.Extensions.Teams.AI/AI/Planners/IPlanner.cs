...
namespace Microsoft.Agents.Extensions.Teams.AI.Planners
{
    ...
    /// </summary>
    public interface IPlanner<TState> where TState : ITurnState
    {
        /// <summary>
        /// Starts a new task.
        /// </summary>
        ...
        Task<Plan> BeginTaskAsync(ITurnContext turnContext, TState turnState, AISystem ai, CancellationToken cancellationToken = default);
        ...
        /// or threads to receive notice of cancellation.</param>
        /// <returns>The plan that was generated.</returns>
        Task<Plan> ContinueTaskAsync(ITurnContext turnContext, TState turnState, AISystem ai, CancellationToken cancellationToken = default);
    }
}
