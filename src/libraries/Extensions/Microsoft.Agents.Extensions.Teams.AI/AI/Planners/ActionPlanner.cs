...
namespace Microsoft.Agents.Extensions.Teams.AI.Planners
{
    ...
    public class ActionPlanner<TState> : IPlanner<TState> where TState : ITurnState
    {
        /// <summary>
        ...
        public async Task<Plan> BeginTaskAsync(ITurnContext context, TState state, AISystem ai, CancellationToken cancellationToken = default)
        {
