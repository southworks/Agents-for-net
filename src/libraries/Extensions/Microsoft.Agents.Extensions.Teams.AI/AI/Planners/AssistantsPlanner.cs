...
#pragma warning restore IDE0130 // Namespace does not match folder structure
{
    ...
    public class AssistantsPlanner<TState> : IPlanner<TState>
        where TState : ITurnState, IAssistantsState
    {
...
#pragma warning restore IDE0052 // Remove unread private members
        ...
        /// <inheritdoc/>
        public async Task<Plan> BeginTaskAsync(ITurnContext turnContext, TState turnState, AISystem ai, CancellationToken cancellationToken)
        {
        ...
        /// <inheritdoc/>
        public async Task<Plan> ContinueTaskAsync(ITurnContext turnContext, TState turnState, AISystem ai, CancellationToken cancellationToken)
        {
            Verify.ParamNotNull(turnContext);
            Verify.ParamNotNull(turnState);
            Verify.ParamNotNull(ai);
