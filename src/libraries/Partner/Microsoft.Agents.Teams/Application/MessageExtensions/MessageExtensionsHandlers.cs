...
namespace Microsoft.Agents.Teams.Application.MessageExtensions
{
    /// <summary>
    ...
    /// or threads to receive notice of cancellation.</param>
    /// <returns>An instance of MessagingExtensionActionResponse.</returns>
    public delegate Task<MessagingExtensionActionResponse> BotMessagePreviewEditHandlerAsync<TState>(ITurnContext turnContext, TState turnState, IActivity activityPreview, CancellationToken cancellationToken) where TState : TurnState;
    ...
    public delegate Task BotMessagePreviewSendHandler<TState>(ITurnContext turnContext, TState turnState, IActivity activityPreview, CancellationToken cancellationToken) where TState : TurnState;
    ...
    public delegate Task<MessagingExtensionResult> QueryHandlerAsync<TState>(ITurnContext turnContext, TState turnState, Query<IDictionary<string, object>> query, CancellationToken cancellationToken) where TState : TurnState;
