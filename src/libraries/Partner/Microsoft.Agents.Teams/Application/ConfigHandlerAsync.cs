...
namespace Microsoft.Agents.Teams.Application
{
    ...
    public delegate Task<ConfigResponseBase> ConfigHandlerAsync<TState>(ITurnContext turnContext, TState turnState, object configData, CancellationToken cancellationToken) where TState : TurnState;
}
