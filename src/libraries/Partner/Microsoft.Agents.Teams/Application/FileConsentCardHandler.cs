...
namespace Microsoft.Agents.Teams.Application
{
    ...
    public delegate Task FileConsentHandler<TState>(ITurnContext turnContext, TState turnState, FileConsentCardResponse fileConsentCardResponse, CancellationToken cancellationToken) where TState : TurnState;
}
