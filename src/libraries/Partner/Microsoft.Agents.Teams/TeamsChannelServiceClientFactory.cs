...
namespace Microsoft.Agents.Teams
{
    /// <summary>
    ...
    public class TeamsChannelServiceClientFactory : IChannelServiceClientFactory
    {
        ...
        public TeamsChannelServiceClientFactory(
            ...
            ILogger logger = null)
        {
            ...
            var tokenEndpoint = configuration?.GetValue<string>($"{nameof(TeamsChannelServiceClientFactory)}:TokenServiceEndpoint");
            ...
            var tokenAudience = configuration?.GetValue<string>($"{nameof(TeamsChannelServiceClientFactory)}:TokenServiceAudience");
        ...
        public Task<IConnectorClient> CreateConnectorClientAsync(ClaimsIdentity claimsIdentity, string serviceUrl, string audience, CancellationToken cancellationToken, IList<string> scopes = null, bool useAnonymous = false)
        {
            ...
            return Task.FromResult<IConnectorClient>(new RestTeamsConnectorClient(
                ...
                typeof(TeamsChannelServiceClientFactory).FullName));
        }
