...
1. This bot isn't tested directly.  It is called directly by the DialogRootBot sample.  To test the DialogRootBot sample, follow the instructions in the [DialogRootBot README](../DialogRootBot/README.md).
