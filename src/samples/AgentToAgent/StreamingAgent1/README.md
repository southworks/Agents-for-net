...
This is a the sample Agent of an Agent communicating with another Agent. For this sample, `StreamingAgent1` is communicating with another Agent (`Agent2`) for a multi-turn conversation using ``DeliveryMode.Stream``.
